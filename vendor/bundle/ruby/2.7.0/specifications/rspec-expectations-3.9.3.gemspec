# -*- encoding: utf-8 -*-
# stub: rspec-expectations 3.9.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "rspec-expectations-3.9.3".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.9.0"])
    ...
    s.add_dependency(%q<rspec-support>.freeze, ["~> 3.9.0"])
